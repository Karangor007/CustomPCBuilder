...
public partial class Cooler_List : System.Web.UI.Page
{
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        ...
        {
            Session["cooler_id"] = "0";
            Response.Redirect("Cooler_master.aspx");
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    protected void btnDeleteRepeater_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            string query = "delete from mst_cooler where id = '" + id + "'";
    ...
    private void bindRptList()
    {
        ...
        try
        {
            ...
            string query = "select * from mst_cooler";
            SqlDataAdapter adp = new SqlDataAdapter(query, conn);
            adp.Fill(ds);
            rptCooler.DataSource = ds;
            rptCooler.DataBind();
