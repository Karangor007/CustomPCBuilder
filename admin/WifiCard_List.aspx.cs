...
public partial class WifiCard_List : System.Web.UI.Page
{
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        ...
        {
            Session["wifi_id"] = "0";
            Response.Redirect("WiFiCard_master.aspx");
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    protected void btnDeleteRepeater_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            string query = "delete from mst_wificard where id = '" + id + "'";
    ...
    private void bindRptList()
    {
        ...
        try
        {
            ...
            string query = "select * from mst_wificard";
            SqlDataAdapter adp = new SqlDataAdapter(query, conn);
            adp.Fill(ds);
            rptWiFi.DataSource = ds;
            rptWiFi.DataBind();
