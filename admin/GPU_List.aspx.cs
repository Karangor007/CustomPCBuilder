...
public partial class GPU_List : System.Web.UI.Page
{
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        ...
        {
            Session["gpu_id"] = "0";
            Response.Redirect("GPU_master.aspx");
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    protected void btnDeleteRepeater_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            string query = "delete from mst_gpu where id = '" + id + "'";
    ...
    private void bindRptList()
    {
        ...
        try
        {
            ...
            string query = "select * from mst_gpu";
            SqlDataAdapter adp = new SqlDataAdapter(query, conn);
            adp.Fill(ds);
            rptGPU.DataSource = ds;
            rptGPU.DataBind();
