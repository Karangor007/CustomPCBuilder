...
public partial class Storage_List : System.Web.UI.Page
{
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        try
        {
            Session["storage_id"] = "0";
            Response.Redirect("Storage_master.aspx");
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    protected void btnDeleteRepeater_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            string query = "delete from mst_storage where id = '" + id + "'";
    ...
    private void bindRptList()
    {
        ...
        try
        {
            ...
            string query = "select * from mst_storage";
            SqlDataAdapter adp = new SqlDataAdapter(query, conn);
            adp.Fill(ds);
            rptStorage.DataSource = ds;
            rptStorage.DataBind();
