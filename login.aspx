                    ...
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Label Text="" ID="lblWarning" CssClass="text-white bg-danger text-center" runat="server" display="dynamic" />
                            </div>
                            <div class="form-label-group">
                                <%--<input type="password" id="inputPassword" class="form-control" placeholder="Password" required>--%>
                                <asp:TextBox TextMode="Password" CssClass="form-control" ID="txtPassword" runat="server" placeholder="Enter Password" />
