<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.master" AutoEventWireup="true" CodeFile="WiFiCard_Master.aspx.cs" Inherits="WiFiCard_Master" %>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body row">
                                    <div class="col-md-8">
                                        <h3 class="text-dark ">Wifi Card Master</h3>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <div id="form1" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="txtSpeed" class="form-control-label">Speed</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                
                                                <asp:TextBox CssClass="form-control" runat="server" placeholder="Enter Speed In Mbps." ID="txtSpeed" />
